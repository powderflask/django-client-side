...
from tests.component import DependencySets, Component, Script, Stylesheet
...
#   Protocol is required for PDF generation (seems wkhtmltopdf cannot resolve uri with no protocol designator)
